...
const Preloader = () => {
  ...
  useEffect(() => {
    // Water fill animation (~1.6s) plus a short pause before the shutter lifts.
        ...
        >
          ...
          >
            ...
            <div className="text-red-900/30">
              {profile.logo}<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              {profile.logo}<span className="text-black">.</span>
            </motion.div>
          </motion.div>
        </motion.div>
      )}
